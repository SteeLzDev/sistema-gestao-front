...
;
function Toaster() {
    const { toasts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
...
"[project]/services/toastService.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const processFailedRequests = (success)=>{
    failedRequests.forEach((request)=>{
        if (success) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(request.config).then((response)=>request.resolve(response)).catch((error)=>request.reject(error));
        } else {
...
apiClient.interceptors.response.use((response)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        try {
            ...
            if (success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Sessão expirada", "Sua sessão expirou. Por favor, faça login novamente.");
            ...
            // Mostrar mensagem ao usuário
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Erro de autenticação", "Ocorreu um erro ao verificar sua autenticação. Por favor, faça login novamente.");
            // Limpar dados de autenticação
            if ("TURBOPACK compile-time falsy", 0) {
                "TURBOPACK unreachable";
            }
    ...
    if (error.response?.status === 403) {
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Acesso negado", "Você não tem permissão para acessar este recurso.");
    }
    // Se for um erro de rede, mostrar mensagem apropriada
    if (error.code === "ECONNABORTED" || !error.response) {
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Erro de conexão", "Não foi possível conectar ao servidor. Verifique sua conexão.");
    }
    return Promise.reject(error);
});
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a95a6227._.js.map