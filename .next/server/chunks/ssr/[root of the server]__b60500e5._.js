...
const processFailedRequests = (success)=>{
    failedRequests.forEach((request)=>{
        if (success) {
            ...
            const token = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getToken();
            if (token) {
...
apiClient.interceptors.response.use((response)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        try {
            ...
            refreshTokenPromise = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].refreshToken();
            ...
            if (success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].logout();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b60500e5._.js.map