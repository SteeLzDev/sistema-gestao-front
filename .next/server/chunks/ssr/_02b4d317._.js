...
const usuarioService = {
    ...
    criarUsuario: async (usuario)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/usuarios", usuario);
            return response.data;
        } catch (error) {
    ...
    atualizarUsuario: async (id, usuario)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/usuarios/${id}`, usuario);
            return response.data;
        } catch (error) {
...
function UsuariosPage() {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { hasPermission } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const canViewUsers = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].VIEW_USERS) || hasPermission("USUARIOS_VISUALIZAR");
    const canCreateUser = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].CREATE_USER) || hasPermission("USUARIOS_CRIAR");
    const canEditUser = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].EDIT_USER) || hasPermission("USUARIOS_EDITAR");
    const canDeleteUser = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].DELETE_USER) || hasPermission("USUARIOS_REMOVER");
    const canManagePermissions = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].MANAGE_PERMISSIONS) || hasPermission("USUARIOS_PERMISSOES");
    // Carregar usuários
...
//# sourceMappingURL=_02b4d317._.js.map