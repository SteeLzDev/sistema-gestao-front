...
function PermissoesUsuarioPage() {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("Estoque");
    const [isLoaded, setIsLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false) // Flag para evitar carregamentos duplicados
    ;
    ...
    const carregarUsuario = async ()=>{
        ...
        try {
            ...
            const userPromise = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].buscarUsuario(userId);
            ...
            if (usuarioData.permissoes && usuarioData.permissoes.length > 0) {
                ...
                try {
                    const permPromise = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].obterPermissoes(userId);
    ...
    const salvarPermissoes = async ()=>{
        try {
            setSaving(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].atualizarPermissoes(userId, permissoes);
            toast({
                title: "Sucesso",
...
//# sourceMappingURL=_0b82b0bd._.js.map