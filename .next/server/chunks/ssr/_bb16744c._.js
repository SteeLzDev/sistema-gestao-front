...
const usuarioService = {
    ...
    removerUsuario: async (id)=>{
        try {
            ...
            // Usar o método DELETE com o apiClient
            ...
            console.log(`Resposta da remoção: Status ${response.status}`);
            console.log(`Dados da resposta:`, response.data);
            // Se a resposta for bem-sucedida mas não tiver dados, retornar um objeto padrão
            if (response.status >= 200 && response.status < 300) {
                if (!response.data) {
                    console.log("Resposta sem dados, mas operação bem-sucedida");
                    return {
                        success: true,
                ...
                console.error(`Resposta inesperada: Status ${response.status}`);
...
function UsuariosPage() {
    ...
    const excluirUsuario = async ()=>{
        ...
        try {
            ...
            console.log(`Usuário ${idExcluido} excluído com sucesso`);
...
//# sourceMappingURL=_bb16744c._.js.map