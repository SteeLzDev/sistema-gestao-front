...
const usuarioService = {
    ...
    // Função específica para atualizar permissões
    atualizarPermissoes: async (id, permissoes)=>{
        try {
            console.log(`Atualizando permissões do usuário ${id}:`, permissoes);
            // Enviar requisição direta para o endpoint de permissões
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/usuarios/${id}/permissoes`, permissoes);
...
const permissionService = {
    ...
    // Nova função para atribuir perfil a um usuário
    atribuirPerfilUsuario: async (usuarioId, perfil)=>{
        try {
            console.log(`Atribuindo perfil ${perfil} ao usuário ${usuarioId}`);
            // Obter o usuário atual
            const usuario = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].buscarUsuario(usuarioId);
            // 1. Atualizar o perfil do usuário
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].atualizarUsuario(usuarioId, {
                ...usuario,
                perfil
            });
            console.log(`Perfil ${perfil} atribuído com sucesso ao usuário ${usuarioId}`);
            // 2. Atribuir permissões padrão com base no perfil
            await permissionService.atribuirPermissoesPorPerfil(usuarioId, perfil);
            // 3. Se o usuário atual for o mesmo que está sendo atualizado, atualizar no localStorage
            if ("TURBOPACK compile-time falsy", 0) {
                "TURBOPACK unreachable";
            }
        } catch (error) {
    ...
    // Nova função para atribuir permissões padrão com base no perfil
...
"[project]/app/usuarios/perfis/[id]/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function GerenciarPerfilUsuario({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const carregarUsuario = async ()=>{
            try {
                setCarregando(true);
                const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].buscarUsuario(userId);
                setUsuario(data);
                setPerfilSelecionado(data.perfil || "");
                // Carregar permissões atuais
                const userPermissoes = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].obterPermissoes(userId);
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: permissoes.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                className: "list-disc pl-5 space-y-1",
                                                children: permissoes.map((perm, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                        className: "text-sm",
                                                        children: perm
                                                    }, index, false, {
                                                        fileName: "[project]/app/usuarios/perfis/[id]/page.tsx",
...
//# sourceMappingURL=_c106dbba._.js.map