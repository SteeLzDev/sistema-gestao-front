...
;
;
const Switch = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(({ className, onCheckedChange, checked, ...props }, ref)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("relative inline-flex items-center cursor-pointer", className),
        children: [
...
"[project]/services/configService.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const configService = {
    ...
    loadGeneralConfig: ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(GENERAL_CONFIG_KEY) || defaultGeneralConfig;
    },
    // Salvar configurações gerais
    saveGeneralConfig: async (config)=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set(GENERAL_CONFIG_KEY, config);
            return true;
        } catch (error) {
    ...
    loadDatabaseConfig: ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(DATABASE_CONFIG_KEY) || defaultDatabaseConfig;
    },
    // Salvar configurações de banco de dados
    saveDatabaseConfig: async (config)=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set(DATABASE_CONFIG_KEY, config);
            return true;
        } catch (error) {
    ...
    testDatabaseConnection: async (config)=>{
        try {
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Conexão bem-sucedida", "A conexão com o banco de dados foi estabelecida com sucesso.");
                return true;
            } else {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Erro de conexão", "Ocorreu um erro ao tentar conectar ao banco de dados.");
            return false;
        }
    },
    // Carregar configurações de notificações
    loadNotificationConfig: ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(NOTIFICATION_CONFIG_KEY) || defaultNotificationConfig;
    },
    // Salvar configurações de notificações
    saveNotificationConfig: async (config)=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set(NOTIFICATION_CONFIG_KEY, config);
            return true;
        } catch (error) {
    ...
    loadSecurityConfig: ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(SECURITY_CONFIG_KEY) || defaultSecurityConfig;
    },
    // Salvar configurações de segurança
    saveSecurityConfig: async (config)=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].set(SECURITY_CONFIG_KEY, config);
            return true;
        } catch (error) {
    ...
    detectDarkMode: ()=>{
        ...
        const savedConfig = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(GENERAL_CONFIG_KEY);
    ...
    clearAllConfigs: ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$cacheServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].clear(CONFIG_CACHE_PREFIX);
    }
};
const __TURBOPACK__default__export__ = configService;
}}),
"[project]/services/erroServices.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/configService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$erroServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/erroServices.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function ConfiguracoesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const isDarkMode = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].detectDarkMode();
        setGeneralConfig((prev)=>({
                ...prev,
                darkMode: isDarkMode
            }));
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].applyDarkMode(isDarkMode);
    }, []);
    // Efeito para aplicar o tema escuro quando a configuração mudar
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].applyDarkMode(generalConfig.darkMode);
    }, [
    ...
    const handleSaveGeneralConfig = async (e)=>{
        ...
        setFeedback(null);
        try {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].saveGeneralConfig(generalConfig);
            if (success) {
                setFeedback({
                    type: "success",
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$erroServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].handleError(error, "Erro ao salvar configurações");
        } finally{
            setLoading(false);
        }
    };
    const handleSaveDatabaseConfig = async (e)=>{
        ...
        setFeedback(null);
        try {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].saveDatabaseConfig(databaseConfig);
            if (success) {
                setFeedback({
                    type: "success",
    ...
    const handleSaveNotificationConfig = async (e)=>{
        ...
        setFeedback(null);
        try {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].saveNotificationConfig(notificationConfig);
            if (success) {
                setFeedback({
                    type: "success",
    ...
    const handleSaveSecurityConfig = async (e)=>{
        ...
        setFeedback(null);
        try {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].saveSecurityConfig(securityConfig);
            if (success) {
                setFeedback({
                    type: "success",
    ...
    const handleTestConnection = async ()=>{
        ...
        setFeedback(null);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$configService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].testDatabaseConnection(databaseConfig);
        } catch (error) {
...
//# sourceMappingURL=_e481cbdf._.js.map