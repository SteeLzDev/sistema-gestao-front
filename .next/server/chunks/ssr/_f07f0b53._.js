...
;
;
const Separator = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(({ className, orientation = "horizontal", decorative = true, ...props }, ref)=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: ref,
        role: decorative ? "none" : "separator",
        "aria-orientation": decorative ? undefined : orientation,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("shrink-0 bg-gray-200 dark:bg-gray-700", orientation === "horizontal" ? "h-[1px] w-full" : "h-full w-[1px]", className),
        ...props
    }, void 0, false, {
...
function UsuariosPage() {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { hasPermission, user, refreshAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [usuarioParaExcluir, setUsuarioParaExcluir] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [excluindo, setExcluindo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [dialogoAberto, setDialogoAberto] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    // Controle para evitar loops infinitos
    const tentativasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    const carregadoRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    const canViewUsers = isAdmin || hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].VIEW_USERS) || hasPermission("USUARIOS_VISUALIZAR");
    const canCreateUser = isAdmin || hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].CREATE_USER) || hasPermission("USUARIOS_CRIAR");
    const canEditUser = isAdmin || hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].EDIT_USER) || hasPermission("USUARIOS_EDITAR");
    const canDeleteUser = isAdmin || hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].DELETE_USER) || hasPermission("USUARIOS_REMOVER");
    const canManagePermissions = isAdmin || hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].MANAGE_PERMISSIONS) || hasPermission("USUARIOS_PERMISSOES");
    // Carregar usuários
    const carregarUsuarios = async ()=>{
        ...
        try {
            ...
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].listarUsuarios();
    ...
    const excluirUsuario = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].removerUsuario(idExcluido);
            ...
            if (err.response && err.response.status === 401) {
                ...
                try {
                    ...
                    // Tentar novamente após renovar o token
                    if (usuarioParaExcluir) {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].removerUsuario(usuarioParaExcluir.id);
                        setUsuarioParaExcluir(null);
                        setDialogoAberto(false);
...
//# sourceMappingURL=_f07f0b53._.js.map