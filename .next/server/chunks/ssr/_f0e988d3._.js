...
;
;
function ProtectedRoute({ children, requiredPermission, requiredPermissions = [], requireAll = false, fallback, showAlert = false, redirectToAccessDenied = true }) {
    const { isAuthenticated, loading, hasPermission } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
//# sourceMappingURL=_f0e988d3._.js.map