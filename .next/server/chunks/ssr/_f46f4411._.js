...
const verificarToken = ()=>{
    ...
    if (!token) {
        console.error("Token não encontrado ao acessar serviço de vendas");
        return false;
    }
    return true;
};
const vendaService = {
    async registrarVenda (venda) {
        try {
            ...
            // Obter o token manualmente para garantir que está sendo enviado
            const token = localStorage.getItem("token");
            console.log("Token usado na requisição:", token ? token.substring(0, 10) + "..." : "Não encontrado");
            // Enviar a requisição com o token explícito
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("vendas", vendaDTO, {
                headers: {
    ...
    async listarVendas () {
        try {
            ...
            console.log("Token usado na requisição:", token ? token.substring(0, 10) + "..." : "Não encontrado");
            // Enviar a requisição com o token explícito
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("vendas", {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    async obterVenda (id) {
        try {
            ...
            console.log("Token usado na requisição:", token ? token.substring(0, 10) + "..." : "Não encontrado");
            // Enviar a requisição com o token explícito
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(url, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
function VendasPage() {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { hasPermission, refreshAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const canViewSales = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].VIEW_SALES) || hasPermission("VENDAS_VISUALIZAR");
            ...
            try {
                ...
                if (!token) {
                    ...
                    toast({
                        ...
                        description: "Sua sessão expirou ou você não está autenticado. Redirecionando para o login...",
                        variant: "destructive"
                    });
                ...
                // Tentar atualizar a autenticação antes de carregar as vendas
                await refreshAuth();
                // Carregar vendas com o token atualizado
...
//# sourceMappingURL=_f46f4411._.js.map