...
const fazerRequisicaoComToken = async (config)=>{
    ...
    try {
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])({
            ...config,
            url,
            headers: {
...
function FilaPage() {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { hasPermission, isAuthenticated, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [processandoAcao, setProcessandoAcao] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const canViewQueue = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].VIEW_QUEUE) || hasPermission("FILA_VISUALIZAR");
    // Verificar se o usuário tem permissão para gerenciar a fila
    const canManageQueue = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Permission"].MANAGE_QUEUE) || hasPermission("FILA_GERENCIAR");
            ...
            if (err.response) {
                if (err.response.status === 401) {
                    ...
                    if (!token) {
                        ...
                        try {
                            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filaService"].getClientesNaFila();
                        } catch (innerError) {
    ...
    const iniciarAtendimento = async (clienteId)=>{
        ...
        try {
            ...
            const atendimento = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filaService"].iniciarAtendimento(clienteId);
    ...
    const finalizarAtendimento = async (atendimentoId)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filaService"].finalizarAtendimento(atendimentoId);
            toast({
    ...
    const removerDaFila = async (clienteId)=>{
        ...
        try {
            ...
            try {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filaService"].removerClienteDaFila(clienteId);
                toast({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        return ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["filaService"].limparCache();
        };
    }, [
        isAuthenticated,
        authLoading,
    ...
    const formatarTempoEspera = (dataHorario)=>{
        try {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(dataHorario), {
...
//# sourceMappingURL=_fb787910._.js.map