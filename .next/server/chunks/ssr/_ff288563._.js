...
class FilaService {
    ...
    async getClientesNaFila() {
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/fila");
    ...
    async getClientesEmAtendimento() {
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/atendimentos");
    ...
    async adicionarClienteNaFila(cliente) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/fila", cliente);
    ...
    async iniciarAtendimento(clienteId) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post(`/fila/${clienteId}/atender`);
            // Atualizar os caches
            if (cacheClientesNaFila) {
    ...
    async finalizarAtendimento(atendimentoId) {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post(`/atendimentos/${atendimentoId}/finalizar`);
            ...
            try {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/atendimentos/${atendimentoId}`);
    ...
    async removerClienteDaFila(clienteId) {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/fila/${clienteId}`);
...
function FilaPage() {
    ...
    const [modoDebug, setModoDebug] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
...
//# sourceMappingURL=_ff288563._.js.map