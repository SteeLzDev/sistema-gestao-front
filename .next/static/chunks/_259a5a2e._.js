(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_259a5a2e._.js", {
...
"[project]/services/toastService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
let toastFn = ()=>console.warn("Toast não inicializado");
const toastService = {
...
const apiClient = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: ("TURBOPACK compile-time value", "http://localhost:8080/sistema-gestao/api") || "http://localhost:8080/sistema-gestao/api",
    headers: {
...
const processFailedRequests = (success)=>{
    failedRequests.forEach((request)=>{
        if (success) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(request.config).then((response)=>request.resolve(response)).catch((error)=>request.reject(error));
        } else {
...
const refreshToken = async ()=>{
    ...
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/auth/refresh", {
            baseURL: ("TURBOPACK compile-time value", "http://localhost:8080/sistema-gestao/api") || "http://localhost:8080/sistema-gestao/api",
            headers: {
...
apiClient.interceptors.response.use((response)=>{
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
        ...
        try {
            ...
            if (success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Sessão expirada", "Sua sessão expirou. Por favor, faça login novamente.");
            ...
            // Mostrar mensagem ao usuário
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Erro de autenticação", "Ocorreu um erro ao verificar sua autenticação. Por favor, faça login novamente.");
            // Limpar dados de autenticação
            if ("TURBOPACK compile-time truthy", 1) {
                localStorage.removeItem("token");
                localStorage.removeItem("user");
    ...
    if (error.response?.status === 403) {
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Acesso negado", "Você não tem permissão para acessar este recurso.");
    }
    // Se for um erro de rede, mostrar mensagem apropriada
    if (error.code === "ECONNABORTED" || !error.response) {
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Erro de conexão", "Não foi possível conectar ao servidor. Verifique sua conexão.");
    }
    return Promise.reject(error);
});
...
//# sourceMappingURL=_259a5a2e._.js.map