(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_340959c5._.js", {
...
function AuthProvider({ children }) {
    ...
    const loadUserFromStorage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[loadUserFromStorage]": ()=>{
            ...
            try {
                ...
                if (!parsedUser.permissoes.includes("VENDA_VISUALIZAR") && parsedUser.permissoes.includes("VENDAS_VISUALIZAR")) {
                    console.log("Adicionando permissão VENDA_VISUALIZAR ao usuário");
                    parsedUser.permissoes.push("VENDA_VISUALIZAR");
                    localStorage.setItem("user", JSON.stringify(parsedUser));
                }
                setUser(parsedUser);
                console.log("Usuário autenticado:", parsedUser.username);
                console.log("Permissões do usuário:", parsedUser.permissoes);
                return true;
            } catch (e) {
    ...
    const refreshAuth = async ()=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${baseUrl}/auth/me`, {
                headers: {
            ...
            if (response.data) {
                ...
                // Adicionar a permissão VENDA_VISUALIZAR se não existir
                if (!updatedUser.permissoes.includes("VENDA_VISUALIZAR") && updatedUser.permissoes.includes("VENDAS_VISUALIZAR")) {
                    console.log("Adicionando permissão VENDA_VISUALIZAR ao usuário");
                    updatedUser.permissoes.push("VENDA_VISUALIZAR");
                }
            ...
            // Se houver erro, tentar carregar do localStorage
            const success = loadUserFromStorage();
            if (!success) {
...
//# sourceMappingURL=_340959c5._.js.map