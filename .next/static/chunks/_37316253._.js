(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_37316253._.js", {
...
const usuarioService = {
    ...
    // Depois (usando DELETE para excluir fisicamente o usuário)
    removerUsuario: async (id)=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/usuarios/${id}`, {
                headers
            });
...
function UsuariosPage() {
    ...
    const excluirUsuario = async ()=>{
        ...
        try {
            ...
            console.log("Chamando usuarioService.removerUsuario...");
            const resultado = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].removerUsuario(idExcluido);
            ...
            console.log("Verificando se o usuário foi realmente excluído...");
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].buscarUsuario(idExcluido);
                // Se chegou aqui, o usuário ainda existe
                console.error(`ALERTA: Usuário ${idExcluido} ainda existe após exclusão!`);
                toast({
                    title: "Atenção",
                    description: "O servidor confirmou a exclusão, mas o usuário ainda existe. Contate o administrador do sistema.",
                    variant: "destructive"
                });
            } catch (err) {
                if (err.response && err.response.status === 404) {
                    console.log(`Confirmado: Usuário ${idExcluido} não existe mais no sistema.`);
                } else {
...
_s(UsuariosPage, "kv9hSyj3viu5y38kZnzy6bZE6gI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_37316253._.js.map