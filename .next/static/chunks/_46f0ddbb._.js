(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_46f0ddbb._.js", {
...
function PermissoesUsuarioPage() {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Estoque");
    const [isLoaded, setIsLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false) // Flag para evitar carregamentos duplicados
    ;
    ...
    const carregarUsuario = async ()=>{
        if (isLoaded) return; // Evitar carregamentos duplicados
        try {
            setLoading(true);
            setError(null);
            // Timeout para evitar carregamento infinito
            const timeoutPromise = new Promise((_, reject)=>setTimeout(()=>reject(new Error("Tempo limite excedido ao carregar dados")), 10000));
            // Carregar dados do usuário com timeout
            const userPromise = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].buscarUsuario(userId);
            const usuarioData = await Promise.race([
                userPromise,
                timeoutPromise
            ]);
            setUsuario(usuarioData);
            // Usar as permissões do usuário diretamente se disponíveis
            if (usuarioData.permissoes && usuarioData.permissoes.length > 0) {
                setPermissoes(usuarioData.permissoes);
            } else {
                // Tentar obter permissões específicas apenas se necessário
                try {
                    const permPromise = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].obterPermissoes(userId);
                    const permissoesData = await Promise.race([
                        permPromise,
                        timeoutPromise
                    ]);
                    ...
                    // Usar array vazio se não conseguir carregar permissões
                    setPermissoes([]);
                    toast({
                        title: "Aviso",
                        description: "Não foi possível carregar as permissões específicas.",
                        variant: "default"
                    });
                }
            }
            setIsLoaded(true) // Marcar como carregado para evitar requisições duplicadas
            ;
        } catch (error) {
    ...
    const handlePermissaoChange = (permissaoId, checked)=>{
        if (checked) {
            ...
            setPermissoes((prev)=>prev.filter((id)=>id !== permissaoId));
        }
    };
    const salvarPermissoes = async ()=>{
        try {
            setSaving(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].atualizarPermissoes(userId, permissoes);
            toast({
                title: "Sucesso",
    ...
    const handleRetry = ()=>{
        setIsLoaded(false) // Resetar flag para permitir novo carregamento
        ;
        carregarUsuario();
    };
    if (loading) {
    ...
    const isAdmin = usuario?.perfil === "Administrador" || usuario?.perfil === "ADMIN";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            usuario && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                ...
                children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        isUsuarioAtivo(usuario) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                            variant: "outline",
                    ...
                    isAdmin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "bg-yellow-50 border border-yellow-200 rounded-md p-4 text-yellow-800",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm font-medium",
                                children: "Administradores têm acesso completo ao sistema. Não é necessário configurar permissões individuais."
                            }, void 0, false, {
                                fileName: "[project]/app/usuarios/permissoes/[id]/page.tsx",
                                lineNumber: 249,
                                columnNumber: 17
...
_s(PermissoesUsuarioPage, "ev62s0fZvUiCs3Qciv4r1Iyritk=", false, function() {
    return [
...
//# sourceMappingURL=_46f0ddbb._.js.map