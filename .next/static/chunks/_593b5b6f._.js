(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_593b5b6f._.js", {
...
"[project]/app/diagnostico-autenticacao/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>DiagnosticoAutenticacao)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
;
;
function DiagnosticoAutenticacao() {
    _s();
    const { user, isAuthenticated, refreshAuth, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DiagnosticoAutenticacao.useEffect": ()=>{
            // Registrar a função toast no serviço
            __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].register(toast);
            // Obter o token do localStorage
            if ("TURBOPACK compile-time truthy", 1) {
                setToken(localStorage.getItem("token"));
            }
            // Verificar se os endpoints de autenticação estão implementados
    ...
    const checkBackendEndpoints = async ()=>{
        try {
            // Verificar se o endpoint /api/auth/me está implementado
            const token = localStorage.getItem("token");
            if (!token) {
                setBackendStatus("error");
                return;
            }
            // Usar apiClient para verificar o endpoint
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/auth/me");
            setBackendStatus("ok");
        } catch (error) {
            console.error("Erro ao verificar endpoints de autenticação:", error);
            setBackendStatus("error");
        }
    };
    const handleRefreshAuth = async ()=>{
        try {
            // Verificar se há token antes de tentar renovar
            if ("object" !== "undefined" && !localStorage.getItem("token")) {
                toast({
                    title: "Não autenticado",
                    description: "Você precisa estar autenticado para renovar o token.",
                    variant: "destructive"
                });
                return;
            }
            ...
            toast({
                ...
                description: "Suas informações de autenticação foram atualizadas com sucesso."
            });
            ...
            toast({
                ...
                description: "Não foi possível atualizar suas informações de autenticação.",
                variant: "destructive"
            });
        }
    };
    const handleClearAuth = ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            toast({
                ...
                description: "Suas informações de autenticação foram removidas."
            });
    ...
    const handleTestToast = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$toastService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Teste de Toast", "Este é um teste do serviço de toast.");
    };
    const handleLogin = ()=>{
        // Redirecionar para a página de login
        window.location.href = "/login";
    };
    // Função para extrair o nome da permissão
    const getPermissionName = (perm)=>{
        if (typeof perm === "string") {
            return perm;
        }
        if (perm && typeof perm === "object") {
            return perm.nome || "Permissão sem nome";
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                ...
                fileName: "[project]/app/diagnostico-autenticacao/page.tsx",
                lineNumber: 129,
                columnNumber: 7
            }, this),
            backendStatus === "error" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                className: "mb-6",
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertTitle"], {
                        children: "Aviso de configuração"
                    }, void 0, false, {
                        fileName: "[project]/app/diagnostico-autenticacao/page.tsx",
                        lineNumber: 134,
                        columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDescription"], {
                        children: "Os endpoints de autenticação (/api/auth/me e /api/auth/refresh) podem não estar implementados corretamente no backend. Isso pode causar problemas na renovação automática de token. Verifique a implementação desses endpoints no backend."
                    }, void 0, false, {
                        fileName: "[project]/app/diagnostico-autenticacao/page.tsx",
                        lineNumber: 135,
                        columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                    children: "Informações sobre o estado atual da autenticação"
                                }, void 0, false, {
                                    fileName: "[project]/app/diagnostico-autenticacao/page.tsx",
                                    lineNumber: 147,
                                    columnNumber: 13
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    user.permissoes && user.permissoes.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                        className: "list-disc pl-5",
                                                        children: user.permissoes.map((perm, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                children: getPermissionName(perm)
                                                            }, index, false, {
                                                                fileName: "[project]/app/diagnostico-autenticacao/page.tsx",
                                                                lineNumber: 175,
                                                                columnNumber: 27
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            token ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-xs break-all bg-gray-100 p-2 rounded",
                                                        children: token
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/diagnostico-autenticacao/page.tsx",
                                                        lineNumber: 190,
                                                ...
                                                children: "Nenhum token encontrado"
                                            }, void 0, false, {
                                                fileName: "[project]/app/diagnostico-autenticacao/page.tsx",
                                                lineNumber: 194,
                                                columnNumber: 19
...
_s(DiagnosticoAutenticacao, "pGwYbpf0NDuOzuMs7hlcXs8zJpo=", false, function() {
    return [
...
_c = DiagnosticoAutenticacao;
var _c;
__turbopack_context__.k.register(_c, "DiagnosticoAutenticacao");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_593b5b6f._.js.map