(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_63528377._.js", {
...
"[project]/services/api.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const api = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: ("TURBOPACK compile-time value", "http://localhost:8080/sistema-gestao/api")
});
...
"[project]/services/filaService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/api.tsx [app-client] (ecmascript)");
;
// Cache local
let cacheClientesNaFila = null;
let cacheClientesEmAtendimento = null;
let ultimaAtualizacao = 0;
// Tempo de expiração do cache em milissegundos (30 segundos)
const CACHE_EXPIRATION = 30 * 1000;
class FilaService {
    // Obter clientes na fila
    async getClientesNaFila() {
        const agora = Date.now();
        // Verificar se o cache é válido
        if (cacheClientesNaFila && agora - ultimaAtualizacao < CACHE_EXPIRATION) {
            console.log("Usando cache para clientes na fila");
            return cacheClientesNaFila;
        }
        try {
            console.log("Buscando clientes na fila da API");
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/fila");
            cacheClientesNaFila = response.data;
            ultimaAtualizacao = agora;
            return response.data;
        } catch (error) {
            console.error("Erro ao buscar clientes na fila:", error);
            // Se houver um erro, mas tivermos dados em cache, retorne-os mesmo expirados
            if (cacheClientesNaFila) {
                console.log("Usando cache expirado para clientes na fila devido a erro");
                return cacheClientesNaFila;
            }
            throw error;
        }
    }
    // Obter clientes em atendimento
    async getClientesEmAtendimento() {
        const agora = Date.now();
        // Verificar se o cache é válido
        if (cacheClientesEmAtendimento && agora - ultimaAtualizacao < CACHE_EXPIRATION) {
            console.log("Usando cache para clientes em atendimento");
            return cacheClientesEmAtendimento;
        }
        try {
            console.log("Buscando clientes em atendimento da API");
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/atendimentos");
            cacheClientesEmAtendimento = response.data;
            ultimaAtualizacao = agora;
            return response.data;
        } catch (error) {
            console.error("Erro ao buscar clientes em atendimento:", error);
            // Se houver um erro, mas tivermos dados em cache, retorne-os mesmo expirados
            if (cacheClientesEmAtendimento) {
                console.log("Usando cache expirado para clientes em atendimento devido a erro");
                return cacheClientesEmAtendimento;
            }
            throw error;
        }
    ...
    async adicionarClienteNaFila(cliente) {
        try {
            console.log("Adicionando cliente à fila:", cliente);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/fila", cliente);
            // Invalidar o cache de clientes na fila
            cacheClientesNaFila = null;
            return response.data;
        } catch (error) {
    ...
    async iniciarAtendimento(clienteId) {
        try {
            console.log(`Iniciando atendimento para cliente ID ${clienteId}`);
            // Verificar se o cliente já está em atendimento para evitar duplicação
            if (cacheClientesEmAtendimento) {
                const clienteJaEmAtendimento = cacheClientesEmAtendimento.find((a)=>a.id === clienteId);
                if (clienteJaEmAtendimento) {
                    console.log(`Cliente ID ${clienteId} já está em atendimento, retornando dados existentes`);
                    return clienteJaEmAtendimento;
                }
            }
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post(`/fila/${clienteId}/atender`);
            // Atualizar os caches
            if (cacheClientesNaFila) {
                cacheClientesNaFila = cacheClientesNaFila.filter((c)=>c.id !== clienteId);
            }
            if (cacheClientesEmAtendimento) {
                // Verificar se o cliente já existe no cache para evitar duplicação
                if (!cacheClientesEmAtendimento.some((a)=>a.id === response.data.id)) {
                    cacheClientesEmAtendimento = [
                        ...cacheClientesEmAtendimento,
                        response.data
                    ];
                }
            ...
            console.error(`Erro ao iniciar atendimento para cliente ID ${clienteId}:`, error);
            throw error;
        }
    }
    // Finalizar atendimento
    async finalizarAtendimento(atendimentoId) {
        try {
            console.log(`Finalizando atendimento ID ${atendimentoId}`);
            // Atualizar o cache imediatamente para melhorar a experiência do usuário
            if (cacheClientesEmAtendimento) {
                cacheClientesEmAtendimento = cacheClientesEmAtendimento.filter((a)=>a.id !== atendimentoId);
            }
            // Tentar finalizar o atendimento no servidor
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post(`/atendimentos/${atendimentoId}/finalizar`);
            console.log(`Atendimento ID ${atendimentoId} finalizado com sucesso`);
        } catch (error) {
            console.error(`Erro ao finalizar atendimento ID ${atendimentoId}:`, error);
            // Tentar uma segunda abordagem com método DELETE se o POST falhar
            try {
                console.log(`Tentando método alternativo para finalizar atendimento ID ${atendimentoId}`);
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete(`/atendimentos/${atendimentoId}`);
                console.log(`Atendimento ID ${atendimentoId} finalizado com método alternativo`);
            } catch (secondError) {
                console.error(`Erro ao finalizar atendimento ID ${atendimentoId} com método alternativo:`, secondError);
    ...
    async removerClienteDaFila(clienteId) {
        try {
            console.log(`Removendo cliente ID ${clienteId} da fila`);
            // Atualizar o cache imediatamente para melhorar a experiência do usuário
            if (cacheClientesNaFila) {
                cacheClientesNaFila = cacheClientesNaFila.filter((c)=>c.id !== clienteId);
            }
            // Tentar remover o cliente no servidor
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete(`/fila/${clienteId}`);
            console.log(`Cliente ID ${clienteId} removido da fila com sucesso`);
        } catch (error) {
            console.error(`Erro ao remover cliente ID ${clienteId} da fila:`, error);
            throw error;
        }
    }
    // Limpar cache
    limparCache() {
        console.log("Limpando cache do serviço de fila");
        cacheClientesNaFila = null;
        cacheClientesEmAtendimento = null;
        ultimaAtualizacao = 0;
    }
}
...
"[project]/app/fila/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/filaService.ts [app-client] (ecmascript)");
...
function FilaPage() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { hasPermission, isAuthenticated, loading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [clientesNaFila, setClientesNaFila] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [clientesEmAtendimento, setClientesEmAtendimento] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [processandoAcao, setProcessandoAcao] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [modoDebug, setModoDebug] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Verificar se o usuário tem permissão para visualizar a fila
    const canViewQueue = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Permission"].VIEW_QUEUE) || hasPermission("FILA_VISUALIZAR");
    // Verificar se o usuário tem permissão para gerenciar a fila
    const canManageQueue = hasPermission(__TURBOPACK__imported__module__$5b$project$5d2f$types$2f$permissions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Permission"].MANAGE_QUEUE) || hasPermission("FILA_GERENCIAR");
    // Função para alternar o modo de depuração
    const toggleModoDebug = ()=>{
        setModoDebug(!modoDebug);
        if (!modoDebug) {
            // Se estiver ativando o modo debug, mostrar informações do token
            const token = localStorage.getItem("token");
            const user = localStorage.getItem("user");
            let info = "Informações de Depuração:\n\n";
            if (token) {
                info += `Token: ${token.substring(0, 20)}...\n`;
                info += `Comprimento do token: ${token.length}\n\n`;
            } else {
                info += "Token não encontrado!\n\n";
            }
            if (user) {
                try {
                    const userData = JSON.parse(user);
                    info += `Usuário: ${userData.username}\n`;
                    info += `Perfil: ${userData.perfil}\n`;
                    info += `Permissões: ${userData.permissoes?.join(", ") || "Nenhuma"}\n`;
                } catch (e) {
                    info += "Erro ao parsear dados do usuário\n";
                }
            } else {
                info += "Dados do usuário não encontrados!\n";
            }
            setDebugInfo(info);
        } else {
            setDebugInfo(null);
    ...
    const carregarFila = async ()=>{
        ...
        try {
            ...
            const [clientesFila, clientesAtendimento] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filaService"].getClientesNaFila(),
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filaService"].getClientesEmAtendimento()
            ]);
            ...
            if (err.response) {
                if (err.response.status === 401) {
                    ...
                    if (!token) {
                        ...
                        try {
                            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filaService"].getClientesNaFila();
                        } catch (innerError) {
    ...
    const iniciarAtendimento = async (clienteId)=>{
        if (!canManageQueue) {
            toast({
        ...
        try {
            ...
            // Verificar se o cliente já está em atendimento para evitar duplicação
            const clienteJaEmAtendimento = clientesEmAtendimento.some((a)=>a.id === clienteId);
            if (clienteJaEmAtendimento) {
                toast({
            ...
            const atendimento = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filaService"].iniciarAtendimento(clienteId);
    ...
    // Finalizar atendimento
    const finalizarAtendimento = async (atendimentoId)=>{
        if (!canManageQueue) {
            toast({
                title: "Permissão negada",
                description: "Você não tem permissão para gerenciar a fila.",
        ...
        try {
            ...
            // Tentar finalizar o atendimento no servidor
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filaService"].finalizarAtendimento(atendimentoId);
            toast({
    ...
    // Remover cliente da fila
    const removerDaFila = async (clienteId)=>{
        if (!canManageQueue) {
            toast({
                title: "Permissão negada",
                description: "Você não tem permissão para gerenciar a fila.",
        ...
        try {
            ...
            try {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filaService"].removerClienteDaFila(clienteId);
                toast({
                ...
                toast({
                    ...
                    description: "O cliente foi removido da fila localmente. A sincronização com o servidor pode ocorrer mais tarde."
                });
            }
        } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FilaPage.useEffect": ()=>{
            ...
            return ({
                "FilaPage.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$filaService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filaService"].limparCache();
                }
            })["FilaPage.useEffect"];
        }
    }["FilaPage.useEffect"], [
    ...
    const formatarTempoEspera = (dataHorario)=>{
        try {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(new Date(dataHorario), {
        ...
        switch(prioridade.toLowerCase()){
            case "alta":
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                    ...
                    fileName: "[project]/app/fila/page.tsx",
                    lineNumber: 408,
                    columnNumber: 16
                }, this);
            case "media":
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDescription"], {
                                children: "Você não tem permissão para visualizar a fila de atendimento."
                            }, void 0, false, {
                                fileName: "[project]/app/fila/page.tsx",
                                lineNumber: 446,
                                columnNumber: 13
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                variant: "outline",
                                onClick: toggleModoDebug,
                                className: modoDebug ? "bg-purple-100 hover:bg-purple-200 border-purple-300" : "",
                                children: [
                                    ...
                                    modoDebug ? "Ocultar Debug" : "Modo Debug"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/app/fila/page.tsx",
                                lineNumber: 461,
            ...
            modoDebug && debugInfo && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                    ...
                    canManageQueue && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Adicione um novo cliente à fila de atendimento"
                                    }, void 0, false, {
                                        fileName: "[project]/app/fila/page.tsx",
                                        lineNumber: 497,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                    className: "w-full",
                                    onClick: ()=>router.push("/fila/adicionar"),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$plus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserPlus$3e$__["UserPlus"], {
                                            className: "mr-2 h-4 w-4"
                                        }, void 0, false, {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Visão geral da fila de atendimento atual"
                                    }, void 0, false, {
                                        fileName: "[project]/app/fila/page.tsx",
                                        lineNumber: 511,
                                        columnNumber: 13
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: clientesNaFila.length
                                                }, void 0, false, {
                                                    fileName: "[project]/app/fila/page.tsx",
                                                    lineNumber: 517,
                                                    columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-2xl font-bold",
                                                    children: clientesEmAtendimento.length
                                                }, void 0, false, {
                                                    fileName: "[project]/app/fila/page.tsx",
                                                    lineNumber: 521,
                                                    columnNumber: 17
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Lista de clientes aguardando atendimento"
                                    }, void 0, false, {
                                        fileName: "[project]/app/fila/page.tsx",
                                        lineNumber: 532,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    lineNumber: 536,
                                    columnNumber: 15
                                }, this) : clientesNaFila.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex justify-center p-4 text-muted-foreground",
                                    children: "Não há clientes aguardando no momento"
                                }, void 0, false, {
                                    fileName: "[project]/app/fila/page.tsx",
                                    lineNumber: 541,
                                    columnNumber: 15
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                            children: clientesNaFila.map((cliente)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(cliente.chegada), "HH:mm")
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/fila/page.tsx",
                                                            lineNumber: 559,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: cliente.espera || formatarTempoEspera(cliente.chegada)
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/fila/page.tsx",
                                                            lineNumber: 560,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: renderizarPrioridade(cliente.prioridade)
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/fila/page.tsx",
                                                            lineNumber: 561,
                                                            columnNumber: 23
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                        ...
                                                                        children: processandoAcao === cliente.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                        children: "Clientes que estão sendo atendidos no momento"
                                    }, void 0, false, {
                                        fileName: "[project]/app/fila/page.tsx",
                                        lineNumber: 602,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    lineNumber: 606,
                                    columnNumber: 15
                                }, this) : clientesEmAtendimento.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex justify-center p-4 text-muted-foreground",
                                    children: "Não há clientes em atendimento no momento"
                                }, void 0, false, {
                                    fileName: "[project]/app/fila/page.tsx",
                                    lineNumber: 611,
                                    columnNumber: 15
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                                            children: clientesEmAtendimento.map((atendimento)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            className: "font-medium",
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(atendimento.inicio), "HH:mm")
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/fila/page.tsx",
                                                            lineNumber: 631,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: formatarTempoEspera(atendimento.inicio)
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/fila/page.tsx",
                                                            lineNumber: 632,
                                                            columnNumber: 23
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            children: atendimento.atendente
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/fila/page.tsx",
                                                            lineNumber: 633,
                                                            columnNumber: 23
                                                        ...
                                                        canManageQueue && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                ...
                                                                children: processandoAcao === atendimento.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                                    className: "mr-2 h-4 w-4 animate-spin inline"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/fila/page.tsx",
                                                                    lineNumber: 642,
...
_s(FilaPage, "+GKcDEpQBbFdjcYXBLptJOD1eUY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
_c = FilaPage;
var _c;
__turbopack_context__.k.register(_c, "FilaPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_63528377._.js.map