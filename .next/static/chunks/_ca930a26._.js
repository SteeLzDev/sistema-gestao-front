(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_ca930a26._.js", {
...
const refreshAuth = async ()=>{
    try {
        ...
        const token = localStorage.getItem("token");
        if (!token) {
            console.warn("Não há token para atualizar");
            return false;
        }
...
const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(getInitialUser());
...
//# sourceMappingURL=_ca930a26._.js.map