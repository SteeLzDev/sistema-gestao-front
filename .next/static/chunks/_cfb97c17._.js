(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_cfb97c17._.js", {
...
;
// Adicionar dados de exemplo para usar como fallback quando a API falhar
const clientesFilaExemplo = [
    {
        id: 1,
        nome: "Maria Silva",
        servico: "Consulta Geral",
        chegada: new Date(Date.now() - 30 * 60000).toISOString(),
        espera: "30 minutos",
        prioridade: "normal",
    ...
    },
    {
        ...
        chegada: new Date(Date.now() - 5 * 60000).toISOString(),
        espera: "5 minutos",
        prioridade: "normal",
...
const clientesAtendimentoExemplo = [
    {
        id: 4,
        ...
        atendente: "Funcionário 1"
    },
    {
        id: 5,
        nome: "Mariana Costa",
        servico: "Exame Especializado",
        chegada: new Date(Date.now() - 60 * 60000).toISOString(),
        inicio: new Date(Date.now() - 15 * 60000).toISOString(),
        espera: "45 minutos",
        prioridade: "alta",
        telefone: "(11) 97777-8888",
        status: "EM_ATENDIMENTO",
        atendente: "Funcionário 2"
    }
];
const filaService = {
    async getClientesNaFila () {
        try {
            ...
            if (!token) {
                console.warn("Token não encontrado ao buscar clientes na fila, usando dados de exemplo");
                return clientesFilaExemplo;
            }
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/fila/clientes");
    ...
    async getClientesEmAtendimento () {
        try {
            ...
            const token = localStorage.getItem("token");
            if (!token) {
                console.warn("Token não encontrado ao buscar clientes em atendimento, usando dados de exemplo");
                return clientesAtendimentoExemplo;
            }
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/fila/atendimentos");
            return response.data;
        } catch (error) {
    ...
    async adicionarClienteNaFila (cliente) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/fila/clientes", cliente);
            return response.data;
        } catch (error) {
    ...
    async iniciarAtendimento (id, atendente = "Atendente") {
        try {
            ...
            const token = localStorage.getItem("token");
            if (!token) {
                console.error("Token não encontrado ao iniciar atendimento");
                throw new Error("Você precisa estar autenticado para acessar este recurso");
            }
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/fila/atendimentos`, {
                clienteId: id,
                atendenteId: 1,
                atendente: atendente
            });
    ...
    async finalizarAtendimento (id) {
        try {
            ...
            const token = localStorage.getItem("token");
            if (!token) {
                console.error("Token não encontrado ao finalizar atendimento");
                throw new Error("Você precisa estar autenticado para acessar este recurso");
            }
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/fila/atendimentos/${id}/finalizar`);
        } catch (error) {
    ...
    async removerClienteDaFila (id) {
        try {
            ...
            const token = localStorage.getItem("token");
            if (!token) {
                console.error("Token não encontrado ao remover cliente da fila");
                throw new Error("Você precisa estar autenticado para acessar este recurso");
            }
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$apiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/fila/clientes/${id}`);
        } catch (error) {
...
"[project]/app/fila/page.tsx [app-client] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, k: __turbopack_refresh__, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/app/fila/page.tsx'
...
//# sourceMappingURL=_cfb97c17._.js.map