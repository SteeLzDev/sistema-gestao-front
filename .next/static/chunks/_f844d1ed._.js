(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_f844d1ed._.js", {
...
"[project]/app/usuarios/perfis/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>GerenciarPerfilUsuario)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)");
...
;
;
function GerenciarPerfilUsuario({ params }) {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    const { refreshAuth, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [tentativas, setTentativas] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    // Função para carregar usuário com retry
    const carregarUsuario = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "GerenciarPerfilUsuario.useCallback[carregarUsuario]": async ()=>{
            ...
            try {
                ...
                try {
                    ...
                    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].buscarUsuario(userId);
                    console.log("Dados do usuário recebidos:", data);
                    setUsuario(data);
                    setPerfilSelecionado(data.perfil || "");
                    // Carregar permissões atuais
                    console.log("Buscando permissões para o usuário:", userId);
                    const userPermissoes = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$usuarioService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].obterPermissoes(userId);
                    ...
                    if (error.response && error.response.status === 401 && tentativas < 1) {
                        ...
                        setTentativas({
                            "GerenciarPerfilUsuario.useCallback[carregarUsuario]": (prev)=>prev + 1
                        }["GerenciarPerfilUsuario.useCallback[carregarUsuario]"]);
                        // Tentar renovar o token
                        try {
                            await refreshAuth();
                            // Tentar novamente após um breve delay
                            setTimeout({
                                "GerenciarPerfilUsuario.useCallback[carregarUsuario]": ()=>carregarUsuario()
                            }["GerenciarPerfilUsuario.useCallback[carregarUsuario]"], 1000);
                            return;
                        } catch (refreshError) {
                            ...
                            setTimeout({
                                "GerenciarPerfilUsuario.useCallback[carregarUsuario]": ()=>router.push("/login")
                            }["GerenciarPerfilUsuario.useCallback[carregarUsuario]"], 2000);
                            return;
                        }
                    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GerenciarPerfilUsuario.useEffect": ()=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                    ...
                    fileName: "[project]/app/usuarios/perfis/[id]/page.tsx",
                    lineNumber: 197,
                    columnNumber: 9
                }, this),
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        children: "Voltar para Lista de Usuários"
                    }, void 0, false, {
                        fileName: "[project]/app/usuarios/perfis/[id]/page.tsx",
                        lineNumber: 215,
                        columnNumber: 11
    ...
    if (!usuario) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    children: "O usuário solicitado não foi encontrado."
                }, void 0, false, {
                    fileName: "[project]/app/usuarios/perfis/[id]/page.tsx",
                    lineNumber: 228,
                    columnNumber: 9
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "p-3 bg-gray-50 rounded-md max-h-40 overflow-y-auto",
                                            children: permissoes.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                className: "list-disc pl-5 space-y-1",
                                                children: permissoes.map((perm, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                        className: "text-sm",
                                                        children: perm
                                                    }, index, false, {
                                                        fileName: "[project]/app/usuarios/perfis/[id]/page.tsx",
                                                ...
                                                className: "text-sm text-gray-500",
                                                children: "Nenhuma permissão atribuída"
                                            }, void 0, false, {
                                                fileName: "[project]/app/usuarios/perfis/[id]/page.tsx",
                                                lineNumber: 281,
                                                columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Ao salvar o perfil, as permissões padrão serão atribuídas automaticamente."
                                        }, void 0, false, {
                                            fileName: "[project]/app/usuarios/perfis/[id]/page.tsx",
                                            lineNumber: 284,
                                            columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                            ...
                                            children: "Gerenciar Permissões Manualmente"
                                        }, void 0, false, {
                                            fileName: "[project]/app/usuarios/perfis/[id]/page.tsx",
                                            lineNumber: 294,
                                            columnNumber: 15
...
_s(GerenciarPerfilUsuario, "2j6XYfVyczzpLcNzM+vfzp2qjxc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
_c = GerenciarPerfilUsuario;
var _c;
__turbopack_context__.k.register(_c, "GerenciarPerfilUsuario");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_f844d1ed._.js.map